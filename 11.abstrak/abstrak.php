...
/*
Abstrak : sebuah class / method kosong yang bisa digunakan untuk kelas bawahnya/ kelas childnya

aturan pada abstract adalah :
1. bisa digunakan pada class maupun method atau fungsi yang ada
2. method pada abstract tidak bisa di inisiasi / atau diberikan suatu nilai / isi suatu variabel
3. abstract pada class ga bisa di inisiasi dalam bentuk objedt misal kalo udh ada 1x $obj1 = new nama_class(); gaboleh buat lagi

contoh penggunaan abstract 

abstract class nama_class{

    // contoh penggunaan pada property
    abstract public $nama_variabel;

    // contoh penggunaan pada method
    abstract public function nama_method();
